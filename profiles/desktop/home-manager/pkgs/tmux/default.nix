...

{
  ...
  home.file = {
    ".config/tmux/tmux.conf".source = pkgs.replaceVars ./tmux.conf {
      pluginsCatppuccinPath = "${pkgs.tmuxPlugins.catppuccin}/share/tmux-plugins/catppuccin/catppuccin.tmux";
      pluginsPainControlPath = "${pkgs.tmuxPlugins.pain-control}/share/tmux-plugins/pain-control/pain_control.tmux";
      pluginsPrefixHighlight = "${pkgs.tmuxPlugins.prefix-highlight}/share/tmux-plugins/prefix-highlight/prefix_highlight.tmux";
      pluginsTmuxFzfPath = "${pkgs.tmuxPlugins.tmux-fzf}/share/tmux-plugins/tmux-fzf/main.tmux";
      pluginsTmuxWhichKeyPath = "${pkgs.tmuxPlugins.tmux-which-key}/share/tmux-plugins/tmux-which-key/plugin.sh.tmux";
    };
  };
  #home.file = {
