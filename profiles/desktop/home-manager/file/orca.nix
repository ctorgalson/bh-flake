...
{
  config = {
    home.file.".local/share/applications/orca-preferences.desktop" = {
      text = ''
        [Desktop Entry]
        Version=1.0
        Type=Application
        Name=Orca Preferences
        Comment=Configure Orca screen reader settings
        Icon=preferences-desktop-accessibility
        Exec=orca -s
        Terminal=false
        Categories=Settings;Accessibility;
        Keywords=screen reader;accessibility;a11y;speech;braille;
      '';
    };

    home.file.".local/share/orca/user-settings.conf" = {
